...
public class PreviewView implements PersistentStateComponent<PreviewViewState>, Disposable {
  ...
  public void initToolWindow(@NotNull ToolWindow toolWindow) {
    ...
    previewArea = new PreviewArea(project, outlinesWithWidgets);
      ...
      public void keyPressed(KeyEvent e) {
        ...
        if (e.getKeyChar() == '\n') {
          ...
          Balloon popup = PropertyEditorPanel
            .showPopup(inspectorStateService, project, tree.getParent(), null, location, flutterAnalysisServer,
                       popupLocation);
        }
      }
  ...
  private void updateOutline(@NotNull FlutterOutline outline) {
    ...
    if (FlutterSettings.getInstance().isShowPreviewArea() && propertyEditPanel == null) {
      ...
      propertyEditPanel = new PropertyEditorPanel(inspectorStateService, project, flutterAnalysisServer, false, false);
