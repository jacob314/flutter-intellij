...
public class Matrix4 {
  ...
  Matrix4.fromBuffer(ByteBuffer buffer, int offset)
    : _m4storage = new double[].view(buffer, offset, 16);
*/
  ...
  void setUpper2x2(Matrix2 arg) {
    final double[] argStorage = arg._m2storage;
    _m4storage[0] = argStorage[0];
    _m4storage[1] = argStorage[1];
...
*/
  ...
  @Override()
  public int hashCode() { return Arrays.hashCode(_m4storage); }

  /// Returns row 0
  public Vector4 getRow0() { return getRow(0); }

  /// Returns row 1
  public Vector4 getRow1() { return getRow(1); }

  /// Returns row 2
  public Vector4 getRow2() { return getRow(2); }

  /// Returns row 3
  public Vector4 getRow3() { return getRow(3); }

  /// Sets row 0 to [arg]
  public void setRow0(Vector4 arg) { setRow(0, arg); }

  /// Sets row 1 to [arg]
  public void setRow1(Vector4 arg) { setRow(1, arg); }

  /// Sets row 2 to [arg]
  public void setRow2(Vector4 arg) { setRow(2, arg); }

  /// Sets row 3 to [arg]
  public void setRow3(Vector4 arg) { setRow(3, arg); }
  ...
  @Override
  public Matrix4 clone() { return Matrix4.copy(this); }
  ...
  void translate(double tx, double ty, double tz, double tw) {
...
*/
  ...
  /// [z].
  Matrix4 scaled(double x) {
    return scaled(x, 1, 1);
  }

  Matrix4 scaled(double x, double y) {
    return scaled(x, y, 1);
  }

  Matrix4 scaled(double x, double y, double z) {
    final Matrix4 ret = clone();
    ret.scale(x, y, z);
    return ret;
  }
  ...
  void copyRotation(Matrix3 rotation) {
    final double[] rStorage = rotation._m3storage;
  ...
  void setRotation(Matrix3 r) {
    final double[] rStorage = r._m3storage;
  ...
  /// Invert [this].
  public double invert() { return copyInverse(this); }
  ...
  // TODO(jacobr): this one might be worth pulling in the matrix3 class for.
