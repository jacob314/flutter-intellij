...
public class PreviewViewController extends WidgetViewController {
        ...
        if (node == null) {
          ...
          if (shiftDown || popupTrigger) {
            ...
            if (data.context.editor != null) {
              ...
              popup = PropertyEditorPanel
                .showPopup(inspectorService, data.context.project, data.context.document, data.context.component, node, null, data.context.flutterDartAnalysisService, pendingPopupOpenLocation);
            }
          }
        }
  ...
  private void onPopupEvent(MouseEvent event) {
