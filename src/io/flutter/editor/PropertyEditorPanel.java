...
public class PropertyEditorPanel extends SimpleToolWindowPanel {
  ...
  public static Balloon showPopup(InspectorGroupManagerService inspectorGroupManagerService,
                                  EditorEx editor,
  ...
  public static Balloon showPopupHelper(InspectorGroupManagerService inspectorService,
                                        Project project,
                                        @Nullable DiagnosticsNode node,
                                        @NotNull InspectorService.Location location,
                                        FlutterDartAnalysisServer service) {
  ...
  private void hotReload() {
    FlutterApp app = inspectorStateServiceClient.getApp();
    if (app != null) {
