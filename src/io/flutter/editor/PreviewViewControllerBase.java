...
public abstract class PreviewViewControllerBase extends WidgetViewController {
  ...
  public PreviewViewControllerBase(WidgetViewModelData data, boolean drawBackground) {
    super(data);
