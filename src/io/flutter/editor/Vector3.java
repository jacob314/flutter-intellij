...
public class Vector3 implements Vector {
  ...
  @Override()
  public double[] getStorage() { return _v3storage; }
  ...
  /// Zero vector.
  Vector3() { _v3storage = new double[3]; }
  public static Vector3 getZero() { return new Vector3(); }

  /// Splat [value] into all lanes of the vector.
  static Vector3 all(double value) { final Vector3 ret = Vector3.getZero(); ret.splat(value); return ret; }

  /// Copy of [other].
  static Vector3 copy(Vector3 other) { final Vector3 ret = Vector3.getZero(); ret.setFrom(other); return ret; }

  /// Constructs Vector3 with given double[] as [storage].
  public Vector3(double[] v3storage) { this. _v3storage = v3storage; }


  /// Generate random vector in the range (0, 0, 0) to (1, 1, 1). You can
  /// optionally pass your own random number generator.
  /*Vector3 statuc random([Math.random rng]) {
    rng ??= new Math.Random();
  ...
  @Override()
  public String toString() { return "[" + _v3storage[0] + "," + _v3storage[1] + "," + _v3storage[2] + "]"; }
  ...
  @Override()
  public int hashCode() { return Arrays.hashCode(_v3storage); }
  ...
  Vector3 operatorSub(Vector3 other)
  {
    final Vector3 ret = clone();
    ret.sub(other);
    return ret;
  ...
  /// Add two vectors.
  Vector3 operatorAdd(Vector3 other) {
    final Vector3 ret = clone();
    ret.add(other);
    return ret;
  }
  ...
  /// Scale.
  Vector3 operatorDiv(double scale) {
    final Vector3 ret = clone();
  ...
  /// Scale by [scale].
  Vector3 operatorScaled(double scale) {
    final Vector3 ret = clone();
    ret.scaled(scale);
    return ret;
  }
...
*/
  ...
  /// Length.
  double getLength() { return Math.sqrt(getLength2()); }
  ...
  Vector3 normalized() { Vector3 ret = Vector3.copy(this); ret.normalize(); return ret; }
  ...
  void postmultiply(Matrix3 arg) {
    final double[] argStorage = arg.storage;
   ...
   */
  void setX(double arg) { _v3storage[0] = arg; }
  void setY(double arg) { _v3storage[1] = arg; }
  void setZ(double arg) { _v3storage[2] = arg; }
  /*
  ...
  double get p => z;
  */
  public double getX() { return  _v3storage[0]; }
  public double getY() {return _v3storage[1]; }
  public double getZ() { return _v3storage[2]; }
  /*
  Vector2 get rr => xx;
  Vector2 get rg => xy;
  Vector2 get rb => xz;
