...
public class InspectorTree extends Tree implements DataProvider {
  ...
  void registerShortcuts(Disposable parentDisposable) {
    ...
    DebuggerUIUtil.registerActionOnComponent(InspectorActions.JUMP_TO_SOURCE, this, parentDisposable);
    DebuggerUIUtil.registerActionOnComponent(InspectorActions.INSPECT_WITH_DEBUGGER, this, parentDisposable);
  }
