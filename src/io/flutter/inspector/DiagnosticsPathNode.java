...
public class DiagnosticsPathNode {
  ...
  public DiagnosticsNode getNode() {
    ...
    return new DiagnosticsNode(json.getAsJsonObject("node"), inspectorService, objectGroup);
  }
  ...
  public ArrayList<DiagnosticsNode> getChildren() {
    ...
    for (int i = 0; i < childrenJson.size(); ++i) {
      children.add(new DiagnosticsNode(childrenJson.get(i).getAsJsonObject(), inspectorService, objectGroup));
    }
    return children;
  }
