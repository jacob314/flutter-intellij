...
/**
 * Manager that prevents memory leaks when using the
 * InspectorService.
 *
 ...
 * references associated with the next frame of UI to display. Once the next
 * frame is ready, you discard the current frame and promote the next frame
 * to the the current frame.
 *
