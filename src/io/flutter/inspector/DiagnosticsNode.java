...
public class DiagnosticsNode {
  ...
  /**
   * If an expired node shows up in the tree it indicates a UI bug.
   */
  public static DiagnosticsNode expired(InspectorService.ObjectGroup group) {
    JsonObject json = new JsonObject();
    json.addProperty("description", "expired");
    return new DiagnosticsNode(json, group, false);
  }
