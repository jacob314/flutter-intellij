...
public class FlutterVmServiceBreakpointHandler extends XBreakpointHandler<XLineBreakpoint<XBreakpointProperties>> {
  ...
  public FlutterVmServiceBreakpointHandler(@NotNull final FlutterVmServiceDebugProcess debugProcess) {
  ...
  public void registerBreakpoint(@NotNull final XLineBreakpoint<XBreakpointProperties> xBreakpoint) {
    ...
    final FlutterVmServiceWrapper vmServiceWrapper = myDebugProcess.getVmServiceWrapper();
...
class IsolateBreakpointInfo {
  ...
  IsolateBreakpointInfo(@NotNull String isolateId, @NotNull FlutterVmServiceDebugProcess debugProcess) {
