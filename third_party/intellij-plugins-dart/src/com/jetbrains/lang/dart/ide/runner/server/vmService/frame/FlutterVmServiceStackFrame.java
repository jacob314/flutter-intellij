...
public class FlutterVmServiceStackFrame extends XStackFrame {
  ...
  public FlutterVmServiceStackFrame(@NotNull final FlutterVmServiceDebugProcess debugProcess,
  ...
  public void computeChildren(@NotNull final XCompositeNode node) {
    if (myException != null) {
      final FlutterVmServiceValue
        exception = new FlutterVmServiceValue(myDebugProcess, myIsolateId, "exception", myException, null, null, true);
    ...
    myDebugProcess.getVmServiceWrapper().getObject(myIsolateId, thisVar.getValue().getClassRef().getId(), new GetObjectConsumer() {
      ...
      public void received(Obj classObj) {
        ...
        if (!staticFields.isEmpty()) {
          ...
          list.addTopGroup(new FlutterStaticFieldsGroup(myDebugProcess, myIsolateId, ((ClassObj)classObj).getName(), staticFields));
  ...
  private void addVars(@NotNull final XCompositeNode node, @NotNull final ElementList<BoundVariable> vars) {
    ...
    for (BoundVariable var : vars) {
      ...
      if (value != null) {
        final FlutterVmServiceValue.LocalVarSourceLocation varLocation =
          "this".equals(var.getName())
          ? null
          : new FlutterVmServiceValue.LocalVarSourceLocation(myVmFrame.getLocation().getScript(), var.getDeclarationTokenPos());
        childrenList.add(new FlutterVmServiceValue(myDebugProcess, myIsolateId, var.getName(), value, varLocation, null, false));
      }
    }
  ...
  public XDebuggerEvaluator getEvaluator() {
    return new FlutterVmServiceEvaluator(myDebugProcess, myIsolateId, myVmFrame);
  }
