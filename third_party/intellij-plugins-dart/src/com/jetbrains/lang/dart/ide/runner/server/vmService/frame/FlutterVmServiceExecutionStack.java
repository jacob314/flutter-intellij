...
public class FlutterVmServiceExecutionStack extends XExecutionStack {
  ...
  public FlutterVmServiceExecutionStack(@NotNull final FlutterVmServiceDebugProcess debugProcess,
    ...
    myTopFrame = topFrame == null ? null : new FlutterVmServiceStackFrame(debugProcess, isolateId, topFrame, null, exception);
  }
