...
public class FlutterVmServiceValue extends XNamedValue {
  ...
  public FlutterVmServiceValue(@NotNull final FlutterVmServiceDebugProcess debugProcess,
  ...
  static void doComputeSourcePosition(@NotNull final FlutterVmServiceDebugProcess debugProcess,
  ...
  private static void reportSourcePosition(@NotNull final FlutterVmServiceDebugProcess debugProcess,
                                           @NotNull final XNavigatable navigatable,
                                           @NotNull final String isolateId,
  ...
  private void addListChildren(@NotNull final XCompositeNode node, @Nullable final ElementList<InstanceRef> listElements) {
    ...
    for (InstanceRef listElement : listElements) {
      childrenList.add(new FlutterVmServiceValue(myDebugProcess, myIsolateId, String.valueOf(index++), listElement, null, null, false));
    }
    ...
    for (MapAssociation mapAssociation : mapAssociations) {
      ...
      childrenList.add(String.valueOf(index++), new XValue() {
        ...
        public void computeChildren(@NotNull XCompositeNode node) {
          final FlutterVmServiceValue key = new FlutterVmServiceValue(myDebugProcess, myIsolateId, "key", keyInstanceRef, null, null, false);
          final FlutterVmServiceValue value =
            new FlutterVmServiceValue(myDebugProcess, myIsolateId, "value", valueInstanceRef, null, null, false);
  ...
  private void addFields(@NotNull final XCompositeNode node, @NotNull final ElementList<BoundField> fields) {
    ...
    for (BoundField field : fields) {
      ...
      if (value != null) {
        childrenList
          .add(new FlutterVmServiceValue(myDebugProcess, myIsolateId, field.getDecl().getName(), value, null, field.getDecl(), false));
      }
    }
    node.addChildren(childrenList, true);
  }
