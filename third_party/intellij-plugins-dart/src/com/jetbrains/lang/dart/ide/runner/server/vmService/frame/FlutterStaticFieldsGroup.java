...
class FlutterStaticFieldsGroup extends XValueGroup {
  ...
  public FlutterStaticFieldsGroup(@NotNull final FlutterVmServiceDebugProcess debugProcess,
      ...
      myDebugProcess.getVmServiceWrapper().getObject(myIsolateId, fieldRef.getId(), new GetObjectConsumer() {
        ...
        public void received(Obj field) {
          ...
          if ("@Instance".equals(instanceRef.getType())) {
            list.add(new FlutterVmServiceValue(myDebugProcess, myIsolateId, ((Field)field).getName(), instanceRef, null, fieldRef, false));
          }
          else if ("Sentinel".equals(instanceRef.getType())) {
            list.add(new XNamedValue(((Field)field).getName()) {
              @Override
              public void computeSourcePosition(@NotNull XNavigatable navigatable) {
                FlutterVmServiceValue.doComputeSourcePosition(myDebugProcess, navigatable, myIsolateId, fieldRef);
              }
