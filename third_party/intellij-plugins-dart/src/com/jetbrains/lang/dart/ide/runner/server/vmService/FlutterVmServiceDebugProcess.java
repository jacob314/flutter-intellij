...
public class FlutterVmServiceDebugProcess extends XDebugProcess {
  private static final Logger LOG = Logger.getInstance(FlutterVmServiceDebugProcess.class.getName());
  ...
  public FlutterVmServiceDebugProcess(@NotNull final XDebugSession session,
    ...
    myBreakpointHandlers = new XBreakpointHandler[]{
      new FlutterVmServiceBreakpointHandler(this),
      new FlutterExceptionBreakpointHandler(this)
    };
  ...
  private void connect(@NotNull final String url) throws IOException {
    ...
    myVmServiceWrapper =
      new FlutterVmServiceWrapper(this, vmService, vmServiceListener, myIsolatesInfo, (FlutterVmServiceBreakpointHandler)myBreakpointHandlers[0]);
